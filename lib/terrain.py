...
class TerrainForest(Terrain):
    ...
    def __init__(self, num, image='forest'):
        ...
        self.objects = {
            ...
            "c": [ load_tile('objects', 'tree_03'),
                False, (0,0,160,128), [64,32], [32,128] ],
            "d": [ load_tile('objects', 'tree_07'),
                False, [0,0,256,128], [32,32], [0,0] ],
            "e": [ load_tile('objects', 'tree_08'),
                False, (0,0,0,0), [256,160], [0,0] ],
            "f": [ load_tile('objects', 'tree_09'),
                False, (0,0,0,0), [192,32], [32,0] ],
            "g": [ load_tile('objects', 'bush_01'),
                True, (0,0,0,0), [32,32], [0,0] ],
            "h": [ load_tile('objects', 'bush_02'),
                False, (0,0,0,0), [32,32], [0,0] ],
            "i": [ load_tile('objects', 'bush_03'),
                False, (0,0,0,0), [32,32], [0,0] ],
            "j": [ load_tile('objects', 'bush_04'),
                False, (0,0,0,0), [32,32], [0,0] ],
            "k": [ load_tile('objects', 'bush_05'),
                False, (0,0,32,32), [32,32], [0,32] ],
